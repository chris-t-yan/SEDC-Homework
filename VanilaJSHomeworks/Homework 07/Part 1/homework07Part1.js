...
buttonNode.addEventListener("click", () => {
    ...
    main.append(storyNode);
    storyNode.textContent = `There was a hero named ${whoNode.value}. He lived in ${whereNode.value} in the times of ${whenNode.value}. It was a great hero indeed.`
});